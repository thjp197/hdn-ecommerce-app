...
import 'package:myecommerceapp/Core/Common/color_conversion.dart';
...
class SizeAndColor extends StatefulWidget {
  ...
  const SizeAndColor({
    super.key, required this.colors, required this.sizes, required this.onColorSelected, required this.onSizeSelected, required this.selectedColorIndex, required this.selectedSizeIndex,
  });
  @override
